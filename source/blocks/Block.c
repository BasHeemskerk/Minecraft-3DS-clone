...
#define TEXTURE_FILES                                                                                                              \
	A(stone, "stone.png")                                                                                                      \
	, A(dirt, "dirt.png"), A(cobblestone, "cobblestone.png"), A(cobblestone_mossy, "cobblestone_mossy.png"), A(grass_side, "grass_side.png"), A(grass_top, "grass_top.png"),  \
	    ...
	    A(wool, "wool.png"), A(bedrock, "bedrock.png"), A(podzol_top, "dirt_podzol_top.png"), A(podzol_side, "dirt_podzol_side.png")
...
const char* BlockNames[Blocks_Count] = {"Air",    "Stone", "Dirt",	 "Grass",  "Cobblestone", "Mossy Cobblestone", "Sand", "Log",
