...
//#define TICKS_PER_SEC 268123480LL
...
int main() {
	...
	World_Init(world, &chunkWorker.queue, 512, 16, 98);
	...
	while (aptMainLoop()) {
		...
		if (keysdown & KEY_START) {
			if (gamestate == GameState_SelectWorld || gamestate == GameState_SplashScreen)
				break;
